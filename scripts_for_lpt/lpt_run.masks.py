...
dataset['field_variable_name'] = 'mask'
dataset['field_units'] = '1' ## This is used only for plotting and NetCDF attributes.
"""
...
lpo_options['multiply_factor'] = 1.0       # e.g., 24.0 for mm/h to mm/day, 1.0 if you already have mm/day.
lpo_options['field_units'] = '1'       # This is used for plotting and NetCDF output.
lpo_options['thresh'] = 1.0                # LP Objects threshold (in units above)
lpo_options['accumulation_hours'] = 0      # Accumulation period for LP objects (hours).
lpo_options['filter_stdev'] = 0            # Gaussian filter stdev, in terms of grid points.
lpo_options['filter_n_stdev_width'] = 3     # Gaussian filter width, how many stdevs to go out?
lpo_options['min_points'] = 10             # Throw away LP objects smaller than this.
# "Cold start mode"
#
...
lpt_options['min_lpt_duration_hours'] = 3*24  # Minumum duration to keep it as an LPT (hours)
lpt_options['fall_below_threshold_max_hours'] = 1   # How long to allow center jumps (hours)

## Merging/Splitting settings for the LPT step.
merge_split_options['allow_merge_split'] = False #True
merge_split_options['split_merger_min_hours'] = 48  # Min duration of a split/merging track to separate it.
...
lpt_options['do_lpt_individual_group_masks'] = True   # Whether to generate mask files for each group of overlapping LPT systems.
...
lpt_options['individual_masks_begin_lptid'] = 11 # LPT ID to start with
lpt_options['individual_masks_end_lptid'] = 11 #99999 # LPT ID to end with
...
lpt_options['mask_include_rain_rates'] = False             # Whether to include masked rain rates in mask output files.
