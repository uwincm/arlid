...
lpo_options['thresh_or_equal'] = True       # Should >= or <= be used?
...
merge_split_options['break_up_merge_split'] = True # Break up merging/splitting tracks? Overrides allow_merge_split
...
lpt_options['do_lpt_individual_group_masks'] = False #True      # Whether to generate mask files for each group of overlapping LPT systems.
...
lpt_options['individual_masks_begin_lptid'] = 1  # LPT ID to start with
lpt_options['individual_masks_end_lptid'] = 1 #99999 # LPT ID to end with
